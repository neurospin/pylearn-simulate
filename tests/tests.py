# -*- coding: utf-8 -*-
"""
The :mod:`simulate.tests.tests` module contains basic functionality for unit
testing. It also has the ability to run all unit tests.

Created on Wed Tue 31 14:45:01 2016
...
def test_all():
    ...
    package_name = "simulate"

    # Find directory.
    testdir = os.path.dirname(os.path.abspath(__file__))
    # TODO: Is there a better way to do this?
    if len(testdir) == 0:
        packagedir = "../%s" % (package_name,)
    elif testdir[-1] == '/':
        packagedir = testdir + "../%s" % (package_name,)
    else:
        packagedir = testdir + "/../%s" % (package_name,)
